...
/**@file cmg711.java
 * @brief Clase con los metodos del CODEC
 *
 * */
/***********************************************************************/
...
public class cmg711 {
     ...
     */
    /** @b Description:  Metodo para codificar.
     *                                                              @if CERO
     *----------------------------------------------------------------------
     * PARAMETROS                                                   @endif
     *  @param src   : Array de bytes a comprimir.
     *  @param offset   : Primer byte a comrimir.
     *  @param len   : Longitud de los datos  comprimir.
     *  @param res   : Array con el resultado de la compresión.
     *  @param offres   : Primera posición a usar en el array de resultado.
     *                                                              @if CERO
     * VALORES_DE_RETORNO/RETURN_VALUES:                            @endif
     *  @return : Longitud de los datos comprimidos.
     ***********************************************************************/
    public int encode( byte[] src, int offset, int len, byte[] res, int offres )
    {
        int j = offset;
        int count = len / 2;
        short sample = 0;
        ...
        for ( int i = 0; i < count; i++ )
        {
            ...
            res[i+offres] = linearToALawSample( sample );
        }
        return count;
    }
     ...
     *  DESCRIPCION/DESCRIPTION:
     */
    /** @b Description:  Metodo para decodificar.
     *                                                              @if CERO
     *----------------------------------------------------------------------
     * PARAMETROS                                                   @endif
     *  @param src   : Array de bytes a decodificar.
     *  @param offset   : Primer byte a decodificar.
     *  @param len   : Longitud de los datos  decodificados.
     *  @param res   : Array con el resultado de la decodificación.
     *                                                              @if CERO
     * VALORES_DE_RETORNO/RETURN_VALUES:                            @endif
     *  @return :
     ***********************************************************************/
